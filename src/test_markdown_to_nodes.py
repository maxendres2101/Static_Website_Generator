...
from markdown_to_nodes import split_nodes_delimiter, extract_markdown_images, extract_markdown_links, split_nodes_image, split_nodes_image, split_nodes_link, text_to_textnodes
...
class TestNodeSplitting(unittest.TestCase):
    ...
    def test_splitting(self):
        ...
        self.assertListEqual(text_to_textnodes(text), res)
